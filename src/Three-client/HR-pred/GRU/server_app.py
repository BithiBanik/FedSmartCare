...
from embeddedexample.task import LSTMModel, get_weights, GRUModel
...
def server_fn(context: Context):
    ...
    ndarrays = get_weights(GRUModel(input_size=1, hidden_size=50, num_layers=1, forecast_horizon=forecast_horizon))
